...
output <- returnfcs(metaDataFile = paste0(configd,"/metadata.xlsx"),
...
output2 <- returnfcs(metaDataFile = paste0(configd,"/metadata3.xlsx"),
                    panelDataFile = paste0(configd,"/panel.xlsx"),
                    dataDirectory = paste0(workd,'/Data'))
...
clusterMergeFile2 = paste0(configd,'/merged3.xlsx')
...
mergedlevels3d <- c("CD4 N","CD4 Tcm_I","CD4 Tcm_II","CD4 Tcm_AcvI","CD4 Tcm_AcvII",
                    "CD4 Tem_I","CD4 Tem_II","CD4 Tem_Acv",
                    "CD8 N","CD8 Tem","CD8 Temra","CD8 Tem_Acv","CD8 Teff_I","CD8 Teff_II","CD8 Teff_Acv",
...
cd8clusters <- c("CD8 N","CD8 Tem","CD8 Temra","CD8 Tem_Acv","CD8 Teff_I","CD8 Teff_II","CD8 Teff_Acv")
cd4clusters <- c("CD4 N","CD4 Tcm_I","CD4 Tcm_II","CD4 Tcm_AcvI","CD4 Tcm_AcvII","CD4 Tem_I","CD4 Tem_II","CD4 Tem_Acv")
...
pdf("plot_functional_box_CD8_C1_med_simplified.pdf",width=4.5,height=6)
for (i in 1:length(markerlist_plot)){
  ggdfsubset<-ggdf2_mn_sub_cd8[ggdf2_mn_sub_cd8$variable==markerlist_plot[i],]
  ggp <- ggplot(ggdfsubset, aes(x=response, y=value))+
    ggtitle(markerlist_plot[i])+
...
pdf("plot_functional_box_CD4_C1_med_simplified.pdf",width=4.5,height=6)
for (i in 1:length(markerlist_plot)){
  ggdfsubset<-ggdf2_mn_sub_cd4[ggdf2_mn_sub_cd4$variable==markerlist_plot[i],]
  ggp <- ggplot(ggdfsubset, aes(x=response, y=value))+
    ggtitle(markerlist_plot[i])+
